...
const SHELL=['/accueil.html','/experience.css','/profile.js','/nutrition.js','/nutrition.css','/barcode.js','/','/index.html','/connexion.html','/auth.css','/auth.js','/app.css','/app.js','/cloud.css','/cloud.js','/config.js','/supabase.js','/manifest.webmanifest','/icon-192.png','/icon-512.png','/apple-touch-icon.png'];
