...
const files=['accueil.html','experience.css','profile.js','nutrition.js','nutrition.css','barcode.js','index.html','connexion.html','auth.css','auth.js','app.css','coach-domain.js','coach-engine.js','coach-storage.js','app.js','cloud.js','cloud.css','manifest.webmanifest','icon-192.png','icon-512.png','apple-touch-icon.png','supabase.js','THIRD_PARTY_NOTICES.txt'];
