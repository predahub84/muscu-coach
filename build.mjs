...
const files=['index.html','connexion.html','auth.css','auth.js','app.css','app.js','cloud.js','cloud.css','manifest.webmanifest','icon-192.png','icon-512.png','apple-touch-icon.png','supabase.js','THIRD_PARTY_NOTICES.txt'];
